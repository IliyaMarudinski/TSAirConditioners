...
import airconditionsapp.areas.gamedata.model.binding.HeroApiModelBinding.Data;
...
import airconditionsapp.areas.gamedata.repositories.HeroRepository;
import airconditionsapp.areas.gamedata.repositories.HeroRoleRepository;
...
//    	System.out.println(heroes.size());
    ...
    public void importItems(ItemsApiModelBinding data) {
		...
		for (Map.Entry<String, airconditionsapp.areas.gamedata.model.binding.ItemsApiModelBinding.Data> entry : data.getData().entrySet()) {
			airconditionsapp.areas.gamedata.model.binding.ItemsApiModelBinding.Data values = entry.getValue();
